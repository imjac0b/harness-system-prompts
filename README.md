...
| --- | --- | --- | --- |
| Codex CLI | `codex-cli 0.156.1` | ✅ Captured | [View Markdown](prompts/codex.md) |
| Codex Desktop | `ChatGPT 26.917.71314 (codex-cli 0.155.0-alpha.16.4)` | ✅ Captured | [View Markdown](prompts/codex-desktop.md) |
| Claude Code | `2.1.281 (Claude Code)` | ✅ Captured | [View Markdown](prompts/claude-code.md) |
...
| Gemini CLI | `0.61.0` | ✅ Captured | [View Markdown](prompts/gemini-cli.md) |
| OpenCode | `1.18.32` | ✅ Captured | [View Markdown](prompts/opencode.md) |
| Kilo Code CLI | `7.7.9` | ✅ Captured | [View Markdown](prompts/kilo-code-cli.md) |
| OpenClaw | `OpenClaw 2026.9.6 (eb377ac)` | ✅ Captured | [View Markdown](prompts/openclaw.md) |
| Hermes Agent | `Hermes Agent v0.19.0 (2026.7.20)` | ✅ Captured | [View Markdown](prompts/hermes-agent.md) |
| Kimi CLI | `2.1.0` | ✅ Captured | [View Markdown](prompts/kimi-cli.md) |
...
| oh-my-pi | `omp/18.3.0` | ✅ Captured | [View Markdown](prompts/omp.md) |
...
| DeepSeek Harness | `0.1.5-rc.3` | ✅ Captured | [View Markdown](prompts/deepseek-harness.md) |
