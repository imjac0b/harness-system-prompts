...
The current date and time in ISO format is `<CURRENT_DATE_TIME>`. This is only a reference for you when searching the web, or checking file modification time, etc. If you need the exact time, use Shell tool with proper command.

## Working Directory

The current working directory is `/home/runner/work/_temp/harness-sandbox`. This should be considered as the project root if you are instructed to perform tasks on the project. Every file system operation will be relative to the working directory if you do not explicitly specify the absolute path. Tools may require absolute paths for some parameters, IF SO, YOU MUST use absolute paths for these parameters.
...
### Built-in
- kimi-cli-help
  - Path: /home/runner/.local/share/uv/tools/kimi-cli/lib/python3.13/site-packages/kimi_cli/skills/kimi-cli-help/SKILL.md
...
- skill-creator
  - Path: /home/runner/.local/share/uv/tools/kimi-cli/lib/python3.13/site-packages/kimi_cli/skills/skill-creator/SKILL.md
