...
## Runtime
Runtime: agent=main | session=agent:main:main | sessionId=<SESSION_ID> | host=<HOSTNAME> | repo=/home/runner/work/_temp/harness-sandbox | os=Linux <KERNEL_VERSION> (x64) | node=v24.18.0 | model=capture/capture-openclaw | default_model=capture/capture-openclaw | shell=bash | thinking=off
