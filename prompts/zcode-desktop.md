...
You have a persistent file-based memory at `/home/runner/work/_temp/zcode-desktop-home/.zcode/cli/memories/projects/harness-sandbox-42351dedb3c58d8b/memory/`. This directory already exists — write to it directly with the Write tool (do not run mkdir or check for its existence). Each memory is one file holding one fact, with frontmatter:
...
- You are powered by the model named capture/capture-zcode-desktop.
